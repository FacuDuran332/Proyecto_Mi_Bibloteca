...
public class PnlBuscarAlumno extends JFrame {
	...
	public PnlBuscarAlumno() {
		...
		btnNewButton.setIcon(new ImageIcon(PnlBuscarAlumno.class.getResource("/images/IcBuscar.png")));
		btnNewButton.setBounds(180, 73, 133, 38);
		pnlIngresar.add(btnNewButton);
