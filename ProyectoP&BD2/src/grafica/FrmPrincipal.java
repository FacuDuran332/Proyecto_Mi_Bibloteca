...
public class FrmPrincipal extends JFrame {
	...
	public FrmPrincipal() {
		...
		btnBuscarAlumno.setBounds(18, 83, 174, 42);
		pnlSocio.add(btnBuscarAlumno);
		
		JButton btnListaAl = new JButton("Lista de Alumnos");
		btnListaAl.setIcon(new ImageIcon(FrmPrincipal.class.getResource("/images/IcLista.png")));
		btnListaAl.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnListaAl.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PnlTablaAlumno TabAl = new PnlTablaAlumno();
				TabAl.setVisible(true);
		...
		btnListaAl.setBounds(18, 136, 174, 43);
		pnlSocio.add(btnListaAl);
